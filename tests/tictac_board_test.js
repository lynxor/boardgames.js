//var b = require("../js/tic-tac-toe-board.js"),
...
//
//            board.put(1,2, b.CROSS);
//            assert.strictEqual(Number.POSITIVE_INFINITY, board.fitness(b.CROSS));
//        });
//
//        it("fitness blocking test", function(){
//            var board = b.instance();
//            board.put(1,1, b.CROSS);
//            board.put(0,0, b.CIRCLE);
//            board.put(1,0, b.CROSS);
//
//            var block = board.copy();
//            block.put(1,2, b.CIRCLE);
//
//            var nonblock = board.copy();
//            nonblock.put(2,0, b.CIRCLE);
//
//            var bfit = block.fitness(b.CIRCLE);
//            var nbfit = nonblock.fitness(b.CIRCLE);
//
//            assert.ok(bfit > nbfit);
//        });
//
//        it("fitness winning test", function(){
//            var board = b.instance();
//            board.put(1,1, b.CROSS);
//            board.put(1,0, b.CROSS);
//
...
//            win.put(1,2, b.CROSS);
//
//            var nonwin = board.copy();
//            nonwin.put(1,0, b.CROSS);
//
//            var wfit = win.fitness(b.CROSS);
//            var nwfit = nonwin.fitness(b.CROSS);
//
//            assert.ok(wfit > nwfit);
//        });
//
